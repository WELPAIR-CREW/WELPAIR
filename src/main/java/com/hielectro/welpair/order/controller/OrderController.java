...
public class OrderController {
    ...
    public String addCart(HttpSession session, @ModelAttribute CartSellProductDTO cartSellProduct, Model model)
//                          @RequestParam("empNo") String empNo) // session - 로그인된 사용자만 받기
    {
        ...
        SellProductDTO sellProduct =
                orderService.checkoutSellProductId(cartSellProduct.getSellProductId());
...
//        System.out.println(member);
        ...
        if(cartSellProduct.getCartAmount() > 0 && sellProduct != null ) {
            ...
            int result1 = orderService.addcart(member.getEmpNo());
...
//                redirectAttributes.addFlashAttribute("failMessage", "장바구니에 담는 것을 실패하였습니다222.");
                ...
                model.addAttribute("successMessage", "장바구니 담기 실패1");
            }
...
//            redirectAttributes.addFlashAttribute("failMessage", "장바구니에 담는 것을 실패하였습니다.111");
            ...
            model.addAttribute("successMessage", "장바구니 담기 실패22");
        }
